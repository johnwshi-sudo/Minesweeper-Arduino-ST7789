...
https://github.com/user-attachments/assets/22e79dff-f1d2-4cee-a333-bb805dfaada8
...
* [Hard Mode Completion Video] https://youtube.com/shorts/LQpjO-c8Tcs?feature=share — (18x18 board, 55 mines)
* [Easy Speedrun Video] https://github.com/user-attachments/assets/f520c01f-3ca9-4409-84d4-60439b6ad3db — (8x8 board, 10 mines)
...
## How It Works
**The main game loop relies on a switch-case block containing the different stages of the game (title screen → difficulty selection→ 
...
## Origin
Before building the hardware version, I prototyped the core game logic in Java as a text-based version. See [/java-prototype](./java-prototype) — contains `Board.java` and `Main.java` — same underlying logic (recursive flood-fill, chording, flag-toggle).
